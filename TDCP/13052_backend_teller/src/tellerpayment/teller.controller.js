...
export const addTeller = async (req, res) => {
  // let key = '7NG3xj3zZw2WyKlT1Ym6jCepRVaA8PwkleY6zX0K';
  try {
    ...
    const results = await axios.post('https://portal.thaidotcompayment.co.th/INETServiceWeb/api/v1/inquiry', body);
