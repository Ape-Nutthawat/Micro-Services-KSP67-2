...
app.use(cors({ origin: ['http://localhost:3001', 'http://localhost:3000', 'https://uat-ksp67-2.thaijobjob.com', 'https://ksp67-2.thaijobjob.com', 'https://ksp67-2.one.th'] }));
